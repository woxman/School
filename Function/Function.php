...
function Panel_A()
{
    ...
    echo("    <a href='?Status1'><div class='P_I'><i class=\"fal fa-user-cog \" style='font-size: 24px; color: whitesmoke;'></i><span>&nbsp;وضعیت دانش آموزان</span></div></a>");
    ...
    echo("    <a href='?Status2'><div class='P_I'><i class=\"fal fa-user-graduate \" style='font-size: 24px; color: whitesmoke;'></i><span>&nbsp;&nbsp;نمره انظباط</span></div></a>");
    echo("    <a href='?Score'><div class='P_I'><i class=\"fal fa-user-graduate \" style='font-size: 24px; color: whitesmoke;'></i><span>&nbsp;&nbsp;تنظیم نمره </span></div></a>");
    echo("  </ul>");
    echo("</nav>");
    echo("<main>");
