...
function Single_Insert($Name1,$Family1,$FatherName1,$Expertise1,$BirthDay1,$Phone1,$Address1)
{
    ...
    {
        global $db;
        $query= "INSERT INTO Student(Name, Family, FatherName, Expertise, BirthDay, Phone, Address) 
...
function Single_Update($Name3,$Family3,$FatherName3,$Expertise3,$BirthDay3,$Phone3,$Address3,$Change3)
{
    ...
    if ($Name3!= "")
    {
        $up1="UPDATE Student SET Name='$Name3' WHERE id='$Change3'";
        mysqli_query($db,$up1);
    }
    if ($Family3 != "")
    {
        $up2="UPDATE Student SET Family='$Family3' WHERE id='$Change3'";
        mysqli_query($db,$up2);
    }
    if ($FatherName3 != "")
    {
        $up3="UPDATE Student SET FatherName='$FatherName3' WHERE id='$Change3'";
        mysqli_query($db,$up3);
    }
    if ($Expertise3 != "")
    {
        $up4="UPDATE Student SET Expertise='$Expertise3' WHERE id='$Change3'";
        mysqli_query($db,$up4);
    }
    if ($BirthDay3 != "")
    {
        $up5="UPDATE Student SET BirthDay='$BirthDay3' WHERE id='$Change3'";
        mysqli_query($db,$up5);
    }
    if ($Phone3 != "")
    {
        $up6="UPDATE Student SET Phone='$Phone3' WHERE id='$Change3'";
        mysqli_query($db,$up6);
    }
    if ($Address3 != "")
    {
        $up7="UPDATE Student SET Address='$Address3' WHERE id='$Change3'";
        mysqli_query($db,$up7);
    }
...
{
    global $db;
    $qt="DELETE FROM Student WHERE id='$di'";
    mysqli_query($db,$qt);
...
{
    global $db;
    $qmu="UPDATE Student SET Expertise='$New_Ex' WHERE Expertise='$Now_Ex'";
    mysqli_query($db,$qmu);
...
{
    global $db;
    $qgd="DELETE FROM Student WHERE Expertise='$dg'";
    mysqli_query($db,$qgd);
...
{
    global $db;
    $qr="SELECT distinct Expertise FROM Student";
